...
if choise == '+': #сложение чисел
   ...
   print("факториал числа", math.factorial(x))
    ...
    b = len(list.split(' '))  # вывод количества слов в строке

    print('количество слов:', b)
    g = set(list)  # формирование множества из списка
    print(g)

    list1 = input(' введите вторую строку слов:')
    c = len(list1.split(' '))  # вывод количества слов в строке

    print('количество слов:', c)
    g = set(list1)  # формирование множества из списка
    print(g)
    words = list.split(',') #удаление запятых
    words1 = list1.split(',')  #удаление запятых
    if (b != c):
